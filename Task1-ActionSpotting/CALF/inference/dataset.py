...
class SoccerNetClipsTesting(Dataset):
    def __init__(self, path, features="ResNET_PCA512.npy",framerate=2, chunk_size=240, receptive_field=80):
        self.path = path
    ...
    def __getitem__(self, index):
        ...
        def feats2clip(feats, stride, clip_length):
            ...
            f = feats[idx,:]
            return f
        feat_half1 = feats2clip(torch.from_numpy(feat_half1), stride=self.chunk_size-self.receptive_field, clip_length=self.chunk_size)
